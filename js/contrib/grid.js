	...
	Preview.prototype = {
		create : function() {
   		...
   		this.$tabcontent = $('<div class="tab-content"></div>').append(this.$desctab, this.$infotab);
			...
			this.$nextPreview = $( '<span class="next nav-arrow"><span class="icon shanticon-arrow3-right"></span></span>' );
			this.$prevPreview = $( '<span class="prev nav-arrow"><span class="icon shanticon-arrow3-left"></span></span>' );
