	...
	Preview.prototype = {
		create : function() {
   		...
   		this.$tabcontent = $('<div class="tab-content"></div>').append(this.$desctab, this.$infotab);
			this.$details = $( '<div class="og-details col-xs-12 col-sm-6"></div>' ).append(this.$tabs, this.$tabcontent);
			
			this.$loading = $( '<div class="og-loading"></div>' );
			this.$fullimage = $( '<div class="og-fullimg col-xs-12 col-sm-6"></div>' ).append( this.$loading );
